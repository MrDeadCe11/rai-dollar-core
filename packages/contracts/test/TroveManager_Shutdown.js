...
contract('TroveManager - Shutdown', async accounts => {
  ...
  it('redeemCollateralForShutdown(): cancels the provided LUSD with debt from Troves with the lowest ICRs and sends an equivalent amount of Collateral', async () => {
    ...
    console.log("+++++++++++++++++++++++++++++")
    const dennis_lusd_before = await lusdToken.balanceOf(dennis)
    console.log("dennis_lusd_before|", dennis_lusd_before.toString())
    console.log("+++++++++++++++++++++++++++++")
    ...
    console.log("+++++++++++++++++++++++++++++")
    const dennis_lusd_after = await lusdToken.balanceOf(dennis)
    console.log("dennis_lusd_after |", dennis_lusd_after.toString())
    console.log("+++++++++++++++++++++++++++++")
