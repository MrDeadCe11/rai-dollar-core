...
interface IActivePool is IPool {
    ...
    function getLUSDShieldedDebt() external view returns (uint);

    function increaseLUSDShieldedDebt(uint _amount) external;

    function decreaseLUSDShieldedDebt(uint _amount) external;
}
